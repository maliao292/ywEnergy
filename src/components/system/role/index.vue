<template>
    <div class="MonContent">
      <p class="monConTit" >系统管理 - <span class="TitactiveColor">角色管理</span></p>
      <!--表单-->
      <div class="monChosen">
        ...
        >
          ...
          <el-table-column label="操作" align="center" class-name="small-padding fixed-width">
            <template slot-scope="scope">
              ...
              <el-button size="mini" type="text" v-if="scope.row.roleId != 1" icon="el-icon-delete" @click="handleDelete(scope.row)">删除</el-button>
            </template>
          </el-table-column>
        </el-table>
      </div>
      ...
      <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
        <el-form ref="form" :model="form" :rules="rules" label-width="80px">
          ...
          <el-form-item v-if="form.roleId != 1" label="菜单权限">
