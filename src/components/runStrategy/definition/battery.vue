  ...
  <div>
    ...
    <div class="reportCon_table">
      ...
      >
        ...
        <el-table-column label="放电电压下限(V)" align="center" prop="lowerlimitvol"/>
        <el-table-column label="放电电量下限(%)" align="center" prop="lowerlimitep" />
        <el-table-column label="充电电量上限(%)" align="center" prop="upperlimitep" />
    ...
    <el-dialog :title="title" :visible.sync="open" width="500px" append-to-body>
      <el-form ref="form" :model="form" :rules="rules" label-width="120px">
        ...
        <el-form-item label="放电电压下限(V)" prop="lowerlimitvol">
          <el-input v-model="form.lowerlimitvol" placeholder="请输入放电电压下限" />
        </el-form-item>
        <el-form-item label="放电电量下限(%)" prop="lowerlimitep">
          <el-input v-model="form.lowerlimitep" placeholder="请输入放电电量下限" />
        </el-form-item>
        <el-form-item label="充电电量上限(%)" prop="upperlimitep">
          <el-input v-model="form.upperlimitep" placeholder="请输入充电电量上限" />
        </el-form-item>
      </el-form>
      ...
      methods: {
        ...
        reset() {
          this.form = {
            ...
            name: undefined,
            type: 1,
            lowerlimitvol: undefined,
            lowerlimitep: undefined,
            upperlimitep: undefined,
          };
          this.resetForm("form");
        },
        /** 搜索按钮操作 */
